...
- Supports voice barge-in: debounced ReSpeaker speech VAD clears local/GStreamer playback and
  sends a one-shot `force_listen` with the next microphone slice.
