...
class Settings:
    ...
    mic_channel: int = 0
    playback_preroll_ms: int = 60
    playback_buffers: int = 3
    ...
    def from_env(cls) -> Settings:
        ...
        settings = cls(
            ...
            playback_preroll_ms=_int("YROBOT_PLAYBACK_PREROLL_MS", 60),
            playback_buffers=_int("YROBOT_PLAYBACK_BUFFERS", 3),
            ...
            barge_attack_ms=_int("YROBOT_BARGE_ATTACK_MS", 100),
            ...
            doa_hz=_float("YROBOT_DOA_HZ", 15.0),
    ...
    def validate(self) -> None:
        ...
        if self.vad_min_rms <= 0 or self.vad_noise_ratio < 1:
